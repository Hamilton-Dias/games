	...
	public void render(Graphics g) {
		if (!isDamaged) {
			if (dir == right_dir) {
				...
				if (hasGun)
					g.drawImage(Entity.GUN_RIGHT_EN, this.getX() - Camera.x + 8, this.getY() - Camera.y, null);
				
			} else if (dir == left_dir) {
				g.drawImage(leftPlayer[index], this.getX() - Camera.x, this.getY() - Camera.y, null);
				if (hasGun)
					g.drawImage(Entity.GUN_LEFT_EN, this.getX() - Camera.x - 8, this.getY() - Camera.y, null);
			...
			if (hasGun) {
				if (dir == left_dir)
					g.drawImage(Entity.GUN_DAMAGE_LEFT, this.getX() -8 - Camera.x, this.getY() - 8 - Camera.y, null);
				else
					g.drawImage(Entity.GUN_DAMAGE_RIGHT, this.getX() -8 - Camera.x, this.getY() - 8 - Camera.y, null);
			}
		}
	}
}
